...
- [ ] **研磨机 TypeA DO 脉冲宽度**：文档标注"3 秒长信号"，代码 Pul​seOutputAsync 仅 100ms。接入研磨机后需确认 PLC 实际要求

## 待修复的小问题

- [ ] **ManipulatorCardViewModel Mode=0** 显示"模式未知(0)"，CraneCard 已显示"待机"，需同步
- [ ] **ForkService Cyl3ExtendAsync M916**：读 M900 起 1 字只能覆盖 M900~M915，写 M916 时读-改-写不完整。接入货叉后需改为读 2 字
